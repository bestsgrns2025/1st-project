...
const allProjects = [
    ...
    },
    {
        ...
        category: 'ecommerce',
        description: 'A stylish and modern e-commerce platform for a fashion brand, featuring a clean UI and seamless checkout process.',
        images: ['https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&h=400&fit=crop'],
    ...
    },
    {
        ...
        category: 'webapp',
        description: 'A mobile application for booking flights, hotels, and rental cars, with a focus on user experience and intuitive design.',
        images: [
            'https://img.freepik.com/free-photo/view-3d-smartphone-with-travel-wallpaper_23-2151052374.jpg',
            '../assets/travels/redbus.svg',
            '../assets/travels/flight_travel.svg',
            '../assets/travels/train_booking.svg'
        ],
    ...
    },
    {
        ...
        category: 'webapp',
        description: 'A platform for real estate agents to manage their listings and clients.',
        images: ['https://img.freepik.com/free-photo/3d-rendering-house-model_23-2150799625.jpg'],
    ...
    },
    {
        ...
        images: ['https://img.freepik.com/free-photo/3d-smartphone-with-fitness-wallpaper_23-2151052383.jpg'],
...
const PortfolioSection = () => {
  ...
  useEffect(() => {
    const normalizedProjects = allProjects.map(project => ({
      ...project,
      images: project.images || (project.image ? [project.image] : []) // Normalize images property
    }));

    if (activeFilter === 'all') {
      setFilteredProjects(normalizedProjects);
    } else {
      setFilteredProjects(normalizedProjects.filter(project => project.category === activeFilter));
    }
  }, [activeFilter]);
        ...
        {filteredProjects.length > 0 ? (
            ...
            {regularProjects.length > 0 && (
              <div className="grid md:grid-cols-3 gap-6">
                {regularProjects.map((project, index) => (
                    ...
                    {/* New: Small gallery for additional images */}
          ...
          <div className="text-center py-16 animate-on-scroll">
            ...
            <p className="text-muted-foreground">
              There are no projects matching the selected filter. Try a different category.
            </p>
          </div>
        )}
